                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input v-model="form.permissions" type="checkbox" class="custom-control-input" 
                            id="create-profile" value="create-job_profile">
                            <label class="custom-control-label" for="create-profile">
                                Can Create Job Profile</label>
                            </div>

                            <div class="custom-control custom-checkbox">
                            <input v-model="form.permissions" type="checkbox" class="custom-control-input" 
                            id="create-job" value="create-job">
                            <label class="custom-control-label" for="create-job">
                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="custom-control custom-checkbox">
                            <input v-model="form.permissions" type="checkbox" class="custom-control-input" 
                            id="full-timesheet" value="full-timesheet">
                            <label class="custom-control-label" for="full-timesheet">
                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="custom-control custom-checkbox">
                            <input v-model="form.permissions" type="checkbox" class="custom-control-input" 
                            id="full-request_leave" value="full-request_leave">
                            <label class="custom-control-label" for="full-request_leave">
                                Can Approve Leave Request</label>
                            </div>

                            <div class="custom-control custom-checkbox">
                            <input v-model="form.permissions" type="checkbox" class="custom-control-input" 
                            id="full-request_reimb" value="full-request_reimb">
                            <label class="custom-control-label" for="full-request_reimb">
                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="custom-control custom-checkbox">
                            <input v-model="form.permissions" type="checkbox" class="custom-control-input" 
                            id="full-user" value="full-user">
                            <label class="custom-control-label" for="full-user">
                                Can Invite/Maintain Users</label>
                            </div>

                            <div class="custom-control custom-checkbox">
                            <input v-model="form.permissions" type="checkbox" class="custom-control-input" 
                            id="full-role" value="full-role">
                            <label class="custom-control-label" for="full-role">
                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="custom-control custom-checkbox">
                            <input v-model="form.permissions" type="checkbox" class="custom-control-input" 
                            id="full-schedule" value="full-schedule">
                            <label class="custom-control-label" for="full-schedule">
                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="custom-control custom-checkbox">
                            <input v-model="form.permissions" type="checkbox" class="custom-control-input" 
                            id="full-xero" value="full-xero">
                            <label class="custom-control-label" for="full-xero">
